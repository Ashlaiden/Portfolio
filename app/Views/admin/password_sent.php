            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <h2 class="fw-bold mb-4 text-success text-uppercase">Email Sent</h2>
                        <p class="text-white-50 mb-5">We sent your new password to your email.<br>You can change it
                            later from your panel settings.</p>
...
<footer class="position-absolute bottom-0 start-0 w-100 bg-dark text-white text-center py-3">
