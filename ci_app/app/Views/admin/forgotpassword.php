            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form method="post" action="<?= admin_url('login/forgot-password') ?>"
                            ...
                            <h2 class="fw-bold mb-4 text-uppercase">Forgot Password</h2>
                            <p class="text-white-50 mb-5">Please enter your account email to receive a new password.</p>
                            ...
                            <button class="btn btn-outline-light btn-lg px-5 w-100" type="submit">Verify</button>
